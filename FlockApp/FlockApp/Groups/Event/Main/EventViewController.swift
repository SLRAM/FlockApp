...
////                self.eventView.eventDetailTableView.reloadData()
////            }
////        }
////    }
...
//        }
//        
//        navigationController?.navigationBar.topItem?.title = unwrappedEvent.eventName
//        
...
////        guard let cell = eventView.eventDetailTableView.dequeueReusableCell(withIdentifier: "peopleCell", for: indexPath) as? EventPeopleTableViewCell else {return UITableViewCell()}
